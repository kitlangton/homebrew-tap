class Tailcode < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kitlangton/tailcode/releases/download/v0.2.1/tailcode-darwin-arm64"
      sha256 "36973d9c81444ede1f4b7eee0ef5f07d065845f462ca05184d1ac93d6866f2e3"
    else
      url "https://github.com/kitlangton/tailcode/releases/download/v0.2.1/tailcode-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/kitlangton/tailcode/releases/download/v0.2.1/tailcode-linux-x64"
